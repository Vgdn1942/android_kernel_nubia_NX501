...
static int usb_diag_update_pid_and_serial_num(uint32_t pid, const char *snum)
{
	...
	//add by chengdongsheng for nubia pid in dload mode
	//pid = 0xffe2;         //0xffc0;modify by chengdongsheng for dload
	pid = 0xffae;           //the new pid ffae was used for replace the ffe2 2013.07.15
	//end by chengdongsheng
	/* update pid */
...
/* Register USB host3, will be used for ZTEMT docking connect */
...
//add by chengdongsheng the isa1200 was default haptic-driver but we don't use it .
...
#endif
//the isa1200 was not used we add the macro so it can register the device
#ifdef CONFIG_HAPTIC_ISA1200
	{
		I2C_FFA | I2C_LIQUID,
		APQ_8064_GSBI1_QUP_I2C_BUS_ID,
...
static unsigned hw_board_type = 0xFF;                                             
